...
class CarController():
  def __init__(self, dbc_name, CP, VM):
    ...
    if int(self.params.get("OpkrVariableCruiseProfile")) == 0 and not self.longcontrol:
      self.SC = Spdctrl()
    elif int(self.params.get("OpkrVariableCruiseProfile")) == 1 and not self.longcontrol:
